...
public class BooleanCircle extends SimpleAnnotatedWidget<Boolean> {
    ...
    private final Property<Color> trueColor = new SimpleObjectProperty<>(this, "colorWhenTrue",
            Color.LAWNGREEN);
    private final Property<Color> falseColor = new SimpleObjectProperty<>(this, "colorWhenFalse",
            Color.DARKRED);

    @FXML
    private void initialize() {
        root.backgroundProperty()
                .bind(Bindings.createObjectBinding(() -> createSolidColorBackground(getColor()),
    ...
    public List<Group> getSettings() {
        return Arrays.asList(Group.of("Colors",
                Setting.of("Color when true", "The color to use when the value is `true`",
